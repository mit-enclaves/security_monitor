#include <errno.h> // DO only include ENOSYS?
#include <api.h>
...
void ecall_from_enclave_trap(uintptr_t *regs, uintptr_t mcause, uintptr_t mepc) {
   ...
   switch(code) {
      ...
      case UBI_SM_ENCLAVE_ACCEPT_MESSAGE:
         retval = accept_message((mailbox_id_t) arg0, (enclave_id_t) arg1);
         break;
      ...
      case UBI_SM_ENCLAVE_SEND_MESSAGE:
         ...
         retval = send_message((enclave_id_t) arg0, (mailbox_id_t) arg1, (uintptr_t) arg2);
         break;
